...
def parse_option():
    ...
    parser.add_argument('--syncBN', type=bool, default='False', help='using synchronized batch normalization')
    parser.add_argument('--warm', type=bool, default='False', help='warm-up for large batch training')
    ...
    if opt.data_folder is None:
        opt.data_folder = '../../datasets/CIFAR-10'
