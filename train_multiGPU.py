...
def parse_args():
    ...
    parser.add_argument('--epochs', type=int, default=10, help='训练epochs数')
    ...
    parser.add_argument('--momentum', default=0.9, type=float, help='动量')
    parser.add_argument('--step', action='append', type=int, default=[], help='列表存的是epoch，代表开始下降学习率的epoch，不填则不下降')
...
def train():
    ...
    optimizer = optim.SGD(net.parameters(), lr=opt.lr, momentum=opt.momentum, weight_decay=opt.wd)  # 选择优化器
